...
class TRoundedImage extends StatelessWidget {
  ...
  final double? margin;
  final bool isCircular; // <-- add this
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        shape:
            isCircular ? BoxShape.circle : BoxShape.rectangle, // <--- AI added
        borderRadius: isCircular ? null : BorderRadius.circular(borderRadius),

        /// <--- AI added
        // borderRadius: BorderRadius.circular(borderRadius),  <--- orignal
      ),
  ...
  Widget _buildImageWidget() {
    ...
    return Container(
      ...
      height: height,
      margin: margin != null ? EdgeInsets.all(margin!) : null,
      padding: EdgeInsets.zero, // REMOVE padding for circle!
      decoration: BoxDecoration(
        border: border,
        color: backgroundColor,
